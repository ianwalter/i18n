...
module.exports = (function () {
  ...
  i18n.__ = function i18nTranslate (phrase) {
    ...
    if (typeof phrase === 'object') {
      const isLocaleString = typeof phrase.locale === 'string'
      const isPhraseString = typeof phrase.phrase === 'string'
      if (isLocaleString && isPhraseString) {
  ...
  i18n.__n = function i18nTranslatePlural (singular, plural, count) {
    var msg; var namedValues; var targetLocale; var args = []
  ...
  var guessLanguage = function (request) {
    if (typeof request === 'object') {
      ...
      if (languageHeader) {
        ...
        var match; var fallbackMatch; var fallback
  ...
  var getStorageFilePath = function (locale) {
    ...
    var filepathJS = path.normalize(directory + pathsep + prefix + locale + '.js')
